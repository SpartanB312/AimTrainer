...
object RenderSystem : Thread() {
    ...
    private var graphicsAPI = API.GL_210
    val compatMode get() = graphicsAPI == API.GL_210
    ...
    override fun run() {
        ...
        if (graphicsAPI == API.GL_450 && !compat.openGL45) {
            graphicsAPI = API.GL_210
