    ...
    override fun onRender(fov: Float, test: Boolean, colorRGB: ColorRGB) {
        ...
        GLHelper.glMatrixScope {
            ...
            RenderUtils.drawArcOutline(
                ...
                0,
                2.5f * scale,
                colorRGB.alpha((colorRGB.a * CrosshairRenderer.transparentAlphaRate).toInt())
            )
            ...
            val innerRadius = 7f
            val gap = 8.5f
            RenderUtils.drawArcOutline(0f, 0f, innerRadius, gap..90f - gap, 0, 2.5f * scale, colorRGB)
            RenderUtils.drawArcOutline(0f, 0f, innerRadius, 90f + gap..180f - gap, 0, 2.5f * scale, colorRGB)
            RenderUtils.drawArcOutline(0f, 0f, innerRadius, 180f + gap..270f - gap, 0, 2.5f * scale, colorRGB)
            RenderUtils.drawArcOutline(0f, 0f, innerRadius, 270f + gap..360f - gap, 0, 2.5f * scale, colorRGB)
        }
    }
