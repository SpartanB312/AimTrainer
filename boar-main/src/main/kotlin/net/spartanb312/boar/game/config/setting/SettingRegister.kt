...
import net.spartanb312.boar.game.config.setting.number.DoubleSetting
import net.spartanb312.boar.game.config.setting.number.FloatSetting
import net.spartanb312.boar.game.config.setting.number.IntegerSetting
import net.spartanb312.boar.game.config.setting.number.LongSetting
